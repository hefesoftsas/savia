...
import { api } from "./api";
import { inspectDocument, type ApiOperation } from "@savia/studio-shared/openapi";
...
function Execution({
  ...
  const targetObject: StudioObject | undefined = objects.data?.data?.find(
    (o: StudioObject) => o.name === target,
  );
