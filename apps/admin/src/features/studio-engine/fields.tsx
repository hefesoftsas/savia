...
import { prepareRecord } from "@savia/studio-shared/rules";
import {
  r2AttachmentPolicy,
  type StudioObject,
...
function NumberField(p: IFieldProps) {
  ...
  const object = p.config?.studioObject as StudioObject | undefined;
...
// Keep the Radix adapter registry extensible, with shadcn controls for supported Studio types.
export const registry = {
  ...
  StudioRelation: <RelationField />,
  StudioCollectionRelation: <CollectionRelationPicker />,
  Toggle: <BooleanField />,
