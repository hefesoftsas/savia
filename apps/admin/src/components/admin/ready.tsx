  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      >
        ...
        <h1 className="text-3xl mb-4">{t("Welcome to shadcn-admin-kit")}</h1>
        <div className="text-lg opacity-75">
          {t("Your application is properly configured.")}
          <br />
          {t("Now you can add a <Resource> as child of <Admin></Admin>")}
        </div>
      </div>
