-- Per-tenant overlays for Savia Request. Global tables remain the platform
-- catalog; tenant tables hold overrides keyed by tenant_id. Empty tenant_id
-- is never stored here: "" always resolves to the global tables.
