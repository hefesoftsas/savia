...
- Variables: fusión por clave (overlay gana). Los secretos de plataforma nunca se revelan a tenants: se ejecutan descifrados pero se leen enmascarados; solo los secretos propios del tenant son revelables. Guardar un secreto vacío en scope de tenant significa "sin override" (vuelve al default de plataforma).
