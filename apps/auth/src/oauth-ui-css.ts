...
.oauth-screen[data-tenant-branding] .oauth-aside.has-login-animation { background: var(--aside); }
.oauth-screen[data-tenant-branding] .oauth-login-animation-wordmark span { color: ${foreground}; }
