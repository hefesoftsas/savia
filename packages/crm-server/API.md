...
Contratos HTTP del runtime Hono (`createCrmApp`). En Savia, estas rutas se montan bajo los prefijos autenticados de dominio de datos o CRM dinámico; aquí se documentan con prefijo `/api` tal como las consumen los tests del paquete.
