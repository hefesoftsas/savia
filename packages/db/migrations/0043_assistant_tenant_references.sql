-- Keep compatibility agency_id column names and encrypted credential scope IDs.
-- Migration 0034 guarantees agency IDs equal tenant IDs, so ciphertext remains valid.
