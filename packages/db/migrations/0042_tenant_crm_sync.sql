...
DROP TRIGGER crm_sync_customer_naturalperson_insert;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_naturalperson_update;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_legalperson_insert;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_legalperson_update;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_clientagency_insert;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_clientagency_update;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_deleted;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_address_insert;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_address_update;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_address_delete;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_legalpersoncontact_insert;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_legalpersoncontact_update;
--> statement-breakpoint
DROP TRIGGER crm_sync_customer_legalpersoncontact_delete;
--> statement-breakpoint
CREATE TABLE crm_sync_rules_backup AS SELECT r.id,r.principal_id,a.tenant_id,r.provider,r.connection_id,r.external_account_id,r.account_label,r.enabled,r.created_at FROM crm_sync_rules r JOIN agencies a ON a.id=r.agency_id;
--> statement-breakpoint
