...
// Tables dropped by 0069_drop_unused_legacy_tables.sql and
// 0070_drop_remaining_legacy_tables.sql (zero runtime/trigger/test/
// migration-0046/import-script references, or import scripts retired with them).
// A re-run must not resurrect them.
// See docs/superpowers/plans/2026-09-24-legacy-tables-cleanup.md.
const droppedLegacyTables = new Set(
  `account_emailaddress account_emailconfirmation api_customerfile api_paymentfile api_policyfile api_propertiesfile api_proposalscarsfile api_sarlaftfile app_changelog app_importdata app_reporthistory auth_group auth_group_permissions auth_permission axes_accessattempt axes_accessattemptexpiration axes_accessfailurelog axes_accesslog business_agencycompliancemailbox_reply_authorized_users business_ramorenewalconfiguration business_sellercommission business_sellerdocument business_sellerdocument_tags business_sellerlog claim_claimdocument claim_claimdocument_tags claim_claimlog claim_coverage compliance_compliancelog compliance_compliancerequest_tags compliance_documentspecification compliance_requestdocument compliance_requestdocument_tags constance_constance django_admin_log django_content_type django_migrations django_session django_site financial_statements_accountnormalizationfile help_newsletter help_newsletterusersurvey help_requestdocument help_requestlog help_trainingcategory help_trainingvideo insurance_beneficiary insurance_endorsementdocument insurance_endorsementdocument_tags insurance_insured insurance_insurershare insurance_paymenttaskreminder insurance_policydocument insurance_policydocument_tags insurance_policylog insurance_reinvestment insurance_reinvestmentterm insurance_sellershare mfa_authenticator notification_attachment notification_customemailtemplatetype notification_emailtemplate_ramos notification_emailtemplateimage notification_graphsubscription notification_internalnotification notification_microsoftgraphevent notification_microsoftgraphnotification notification_ramoconfiguration operation_paymentamount operation_paymentcollectionfollowup operation_paymentlog operation_paymentresponsible operation_reimbursement operation_reimbursementreport_reimbursements operation_settlementdocument operation_settlementdocument_tags operation_settlementlog operation_task_tags operation_taskassignmentrule_insurers operation_taskassignmentrule_ramos operation_taskassignmentrule_sellers operation_taskdocument operation_taskdocument_tags operation_tasklog production_data_normalizationfile production_data_productiondata redactor_redactorfile renewal_documentspecification renewal_documentspecification_ramo renewal_initialstep renewal_renewal renewal_renewaldocument renewal_renewaldocument_tags renewal_renewallog sales_contractleadsimportfile sales_entitycity sales_saleaudio sales_saletranscription socialaccount_socialaccount socialaccount_socialapp socialaccount_socialapp_sites socialaccount_socialtoken survey_npsresponse survey_npssurvey user_mfaauthenticationlog user_trusteddevice user_user_groups user_user_user_permissions user_usercomplementarydata customer_client customer_group business_commercialunit app_economicactivity api_key app_bank app_documenttag business_agency_renewal_task_managers business_agencycomplementarydata business_agencycompliancemailbox business_allianzconnectionkey business_axaconnectionkey business_bolivarconnectionkey business_chubbconnectionkey business_defaultcommission business_equidadconnectionkey business_hdiconnectionkey business_mapfreconnectionkey business_previsoraconnectionkey business_qualitasconnectionkey business_renewalconfiguration business_sbsconnectionkey business_seller business_solidariaconnectionkey business_suraconnectionkey business_zurichconnectionkey claim_claim claim_claimstatus claim_claimsubstatus claim_claimtype compliance_compliancecancellationreason compliance_complianceprogramtype compliance_compliancerequest compliance_compliancetag compliance_processstepemailtemplate customer_clientlog customer_consortium customer_customersellershare customer_document customer_document_tags customer_prospect customer_prospectdocument customer_prospectdocument_tags customer_prospectlog financial_statements_accountnormalization financial_statements_agencyauthentication financial_statements_financialreportfile financial_statements_financialreportrequest financial_statements_financialreportrequest_agencies financial_statements_financialstatement help_request help_requestcategory insurance_agencyshare insurance_endorsement insurance_policy insurance_reinvestmentactivity insurance_term notification_configuration notification_emailtemplate notification_externalnotification operation_collectionfile operation_payment operation_portfolioreconciliationfile operation_reconciliationfile operation_reimbursementreport operation_settlement operation_task operation_taskassignmentrule operation_tasktag operation_tasktype production_data_importproductiondatafile production_data_standardizeinsurer production_data_standardizeramo renewal_initialstepconfig renewal_nonrenewalreason sales_contractlead sales_entity sales_holder sales_operator sales_plan sales_product sales_provider sales_sale user_role user_user`.split(
    /\s+/,
  ),
);
const projectedTables = tables.filter(
  (table) =>
    !publicProjections.has(table.table_name) &&
    !droppedLegacyTables.has(table.table_name),
);
